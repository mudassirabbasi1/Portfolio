...
export const PROJECTS = [
  ...
  },
  {
    ...
    description: "A Python implementation of the Fibonacci sequence generator built during the Rhombix Technologies internship. Demonstrates clean algorithmic thinking using the mathematical recurrence relationship F(n) = F(n-1) + F(n-2).",
    tech: ["Python", "Algorithms", "Recursion"],
    link: "https://github.com/mudassirabbasi1/RhombixTechnologies_Tasks",
    type: "Internship · Rhombix Technologies",
  },
];
...
export const EXPERIENCE = [
  {
    ...
    period: "2025 - Present",
    description: "Hands-on internship focused on Python development. Built practical projects including a Fibonacci Generator, sharpening algorithmic thinking and clean code practices within a professional environment.",
  },
  {
    role: "CS Graduate",
...
Experience: Python Development Intern at Rhombix Technologies (2025 - Present).
...
4. Fibonacci Generator: Internship project at Rhombix Technologies demonstrating algorithmic thinking and recursion in Python.
